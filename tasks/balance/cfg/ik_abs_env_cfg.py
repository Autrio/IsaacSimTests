...
import omni.isaac.lab_tasks.manager_based.manipulation.Balance.mdp as mdp
...
##
# Rigid object Balance environment.
##


@configclass
class FrankaCubeBalanceEnvCfg(joint_pos_env_cfg.FrankaCubeBalanceEnvCfg):
